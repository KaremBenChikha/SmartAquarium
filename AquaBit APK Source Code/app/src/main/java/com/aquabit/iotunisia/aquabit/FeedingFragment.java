...
public class FeedingFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.feeding_layout,null);
        final TextView progressTextView = (TextView) rootView.findViewById(R.id.notif);
        SeekBar seekBar = rootView.findViewById(R.id.feed_seekbar);
        ...
        seekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                ...
                String label = "Set amount : "+ progressChangedValue + " gr";
        ...
        Button button = rootView.findViewById(R.id.schedule);
            ...
            public void onClick(View view) {
                ...
                mTimePicker = new TimePickerDialog(getContext(), new TimePickerDialog.OnTimeSetListener() {
                    ...
                    public void onTimeSet(TimePicker timePicker, int selectedHour, int selectedMinute) {
                        Toast.makeText(getActivity().getApplicationContext(),"Feeding scheduled for : " + selectedHour + ":" + selectedMinute,
                                 Toast.LENGTH_LONG)
                                .show();
                    }
        ...
        Switch mSwitch = rootView.findViewById(R.id.switch_feed);
